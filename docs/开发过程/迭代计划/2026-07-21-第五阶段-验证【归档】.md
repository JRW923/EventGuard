...
> - draw.io（推荐）：导入 `docs/系统设计【归档】.md` 第 2 章的 ASCII 架构图，绘制后导出 PNG
...
cd D:/File/Studyproject/EventGuard
# README 中所有链接可达
ls README.md docs/architecture.png docs/interview-mapping.md docs/演示脚本.md docs/ai-vs-baseline.md
# 期望：所有文件存在
...
# 5. 文档检查
cd ..
ls docs/演示脚本.md docs/ai-vs-baseline.md docs/architecture.png docs/interview-mapping.md README.md
# 期望：全部存在
```
...
**1. Spec coverage（对照 实施计划【归档】.md M5）**
...
- M5.5 5 分钟 Demo 脚本 → Task 5 ✓（演示脚本.md 6 个场景 + 录屏指令）
