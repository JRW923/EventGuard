...
| 能力 | 对应设计文档章节 | 说明 | 状态（截至 2026-08-03） |
|------|----------------|------|------|
...
| Saga 编排 | 7.4 | 补偿端完整实现 | 已实现（2026-08-03，`compensation/saga/` 包 + SagaTrigger + 审批流） |
| 网关抽象层 | 7.5 | 支付/库存/通知 Ports & Adapters | 已实现（2026-08-03，Mock 默认 + 支付宝/企业微信/HTTP 适配器示例，见 README「网关接入」） |
