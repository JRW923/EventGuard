# EventGuard：电商订单事件溯源与 AI 异常检测平台设计文档（历史决策稿）

> **现状请先看：[当前架构基线](当前架构基线.md)。**
> 本文保留 2026-07-21 的 MVP 设计、演进过程和决策背景。文中出现的 MVP/V2/远期/计划性内容不代表当前代码；当前实现、已知边界和组件职责以“当前架构基线”为准。
...
> 本文以下为设计蓝图，实现细节见代码与 `docs/验证报告/验证记录.md` §8。
